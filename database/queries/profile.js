...
export const findUsers = async (
  ...
  and ((uia."userId_A" = ${userIdStr} and uia.impression_1 is null) or (uia."userId_B" = ${userIdStr} and uia.impression_2 is null) or ((uia."userId_A" is null or uia."userId_A" != ${userIdStr}) and (uia."userId_B" is null or uia."userId_B" != ${userIdStr})))
